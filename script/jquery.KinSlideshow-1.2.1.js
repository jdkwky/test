...
$.fn.KinSlideshow = function(settings){
	  ...
	  settings = jQuery.extend({
		   ...
		   isHasTitleBar:true,
		   titleBar:{titleBar_height:18,titleBar_bgColor:"#000000",titleBar_alpha:0.5},
		   isHasTitleFont:true,
	  ...
	  var titleBar_Bak = {titleBar_height:18,titleBar_bgColor:"#000000",titleBar_alpha:0.5}
	 ...
	 function KSS_setTitleBar(){
		...
		$(ksbs+" .KSS_titleBar").css({height:getTitleBar_Height,width:400,position:"absolute",bottom:2,left:2})
	 ...
	 function KSS_setTitleFont(){
		 if(settings.isHasTitleFont){
			...
			$(ksbs+" .KSS_titleBox").css({height:getTitleBar_Height,width:"100%",position:"absolute",bottom:-3,left:0})
	 ...
	 function KSS_setBtn(){
		 ...
		 if(settings.isHasBtn && KSS_imgaeLength >= 2){
			 $(ksthis).append("<div class='KSS_btnBox' style='position:absolute;right:25px;bottom:4px; z-index:100'></div>");
			 var KSS_btnList = "";
			 ...
			 $(ksbs+" .KSS_btnBox #btnlistID li").css({listStyle:"none",float:"left",width:18,height:18,borderWidth:settings.btn.btn_borderWidth,borderColor:settings.btn.btn_borderColor,borderStyle:"solid",background:settings.btn.btn_bgColor,textAlign:"center",cursor:"pointer",marginLeft:3,fontSize:12,fontFamily:settings.btn.btn_fontFamily,lineHeight:"12px",opacity:settings.btn.btn_bgAlpha,color:settings.btn.btn_fontColor});
